...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = ADC13_Pin|ADC10_Pin|ADC11_Pin|ADC12_Pin
                          |PP_SPARE_SPI_ADC_Pin|PP_SPARE_UART_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, ADC13_Pin|ADC10_Pin|ADC11_Pin|ADC12_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC4_Pin|ADC6_Pin|ADC5_Pin|ADC3_Pin
                          |ADC7_Pin);

    HAL_GPIO_DeInit(GPIOB, ADC9_Pin|ADC8_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, ADC1_Pin|ADC0_Pin|ADC4_Pin|ADC6_Pin
                          |ADC5_Pin|ADC3_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOF, ADC15_Pin|ADC14_Pin|PP_SPARE_I2C_ADC_Pin|ZION_SENSE_Pin
                          |PP_CONFIG_ADC_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(SPARE_I2C_SDA_3V3_GPIO_Port, SPARE_I2C_SDA_3V3_Pin);

    HAL_GPIO_DeInit(SPARE_I2C_SCL_3V3_GPIO_Port, SPARE_I2C_SCL_3V3_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(SOC_I2C_SDA_3V3_GPIO_Port, SOC_I2C_SDA_3V3_Pin);

    HAL_GPIO_DeInit(SOC_I2C_SCL_3V3_GPIO_Port, SOC_I2C_SCL_3V3_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PF14     ------> I2C4_SCL
    */
    HAL_GPIO_DeInit(STM_ZION_I2C_SDA_GPIO_Port, STM_ZION_I2C_SDA_Pin);

    HAL_GPIO_DeInit(STM_ZION_I2C_SCL_GPIO_Port, STM_ZION_I2C_SCL_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, LCD_SCLK_Pin|LCD_MISO_Pin|LCD_MOSI_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PH6     ------> SPI5_SCK
    */
    HAL_GPIO_DeInit(GPIOH, SPARE_SS_L_3V3_Pin|SPARE_MISO_3V3_Pin|SPARE_SCLK_3V3_Pin);

    HAL_GPIO_DeInit(SPARE_MOSI_3V3_GPIO_Port, SPARE_MOSI_3V3_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC10     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOC, SPARE_UART_RX_3V3_Pin|SPARE_UART_TX_3V3_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(SOC_UART_TX_3V3_GPIO_Port, SOC_UART_TX_3V3_Pin);

    HAL_GPIO_DeInit(SOC_UART_RX_3V3_GPIO_Port, SOC_UART_RX_3V3_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE10     ------> UART7_CTS
    */
    HAL_GPIO_DeInit(GPIOE, FTDI_UART_RX_Pin|FTDI_UART_CTS_L_Pin|FTDI_UART_TX_Pin|FTDI_UART_RTS_L_Pin);
